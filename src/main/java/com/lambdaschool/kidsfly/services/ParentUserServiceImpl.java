...
public class ParentUserServiceImpl implements ParentUserService{
    ...
    public ParentUser save(ParentUser parentuser) {
        ...
        for (Trip t : parentuser.getTrips()){
            // String date, int passengercount, String luggagetype, ParentUser parentuser, StaffUser staffuser
            newParentUser.getTrips().add(new Trip(t.getDate(), t.getPassengercount(), t.getLuggagetype(), newParentUser));
        }
