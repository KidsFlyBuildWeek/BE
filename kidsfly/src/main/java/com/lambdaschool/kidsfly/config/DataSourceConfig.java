package com.lambdaschool.kidsfly.config;

import com.lambdaschool.kidsfly.KidsFlyApplication;
...
{
    private static final Logger logger = LoggerFactory.getLogger(KidsFlyApplication.class);
