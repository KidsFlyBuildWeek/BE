...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String[] args) throws Exception {
        ...
        StaffUser frank = new StaffUser("fskeever", "pass123", "317-555-1010", "fskeevz@email.com", "Frank Skeever", "approved", "12/02/1948", "Denver, CO");
        ...
        p1.getTrips().add(new Trip("9/23/2019", 4, 1, "ORD", "carryon", p1, null));
        ...
        p2.getTrips().add(new Trip("11/11/2019", 2, 3, "IND", "checked", p2, frank));
        p2.getTrips().add(new Trip("01/23/2020", 1, 2, "LAX","carryon", p2, null));
